//https://github.com/TelescopeJS/Telescope/blob/master/packages/telescope-i18n/i18n.js
...
i18n = {
  t: function (str, options) {
    if (Meteor.isServer) {
      return TAPi18n.__(str, options, getSetting('language', 'sk'));
    } else {
...
Meteor.startup(function () {
  ...
  if (Meteor.isClient) {
    ...
    setLanguage(getSetting('language', 'sk'));
  }
